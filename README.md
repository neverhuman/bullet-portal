...
| rendered | `just rendered` | all 24 mocked Playwright projection/SSE cases with exact identities and a nonzero/all-pass JUnit report; locally on xbabe2 outside CI |
