...
assert(
  read("ops/ci/fast.sh").includes(
    'assert-report.mjs vitest "$reports/vitest.json" 185',
  ),
  "exact 185-test Vitest count ratchet absent",
);
assert(
  read("ops/ci/fast.sh").includes(
    "597ea29408d79df50d9ad29eef7a418051bcd8308f50ad984f876db888cd7afc",
